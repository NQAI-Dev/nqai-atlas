...
def handle(req):
    ...
    if method == "tools/list":
        return result(request_id, {"tools": [
            ...
            {"name": "atlas_progress", "description": "Evidence-backed progress report: commits, tests, URLs, and blockers derived from recent Atlas records.", "inputSchema": {"type": "object", "properties": {"entity": {"type": "string", "description": "Restrict the report to a specific entity (optional)"}, "days": {"type": "integer", "minimum": 1, "description": "Recent-activity window in days (default 7)"}}}},
        ]})
